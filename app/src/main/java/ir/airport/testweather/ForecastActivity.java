...
ImageView imgShow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String Url = "https://api.openweathermap.org/data/2.5/forecast/daily?units=metric&q="+City+"&appid=141a44d6c157c2a60e5e70551c399aba";// + intent.getStringExtra("ItemID");
        Log.d("svtest", Url);
            ...
            public void onSuccess(int statusCode, Header[] headers, String responseString) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonoArray.length(); i++) {
                        ...
                        if (i==0)
                        {
                            mData.add(new DetailWeather("Today",jsonWSub.getString("icon"),jsonWSub.getString("description"), day.getString("day")+"°C"));
                        }
                        else if (i == 1)
                        {
                            mData.add(new DetailWeather("Tommorow",jsonWSub.getString("icon"), jsonWSub.getString("description"), day.getString("day")+"°C"));
                        }
                        else if (i !=  0 && i !=  1)
                        {
